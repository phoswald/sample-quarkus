...
class ApplicationTest {
    ...
    void getIndexPage() {
        when()
                ...
                .body(containsString("<title>Quarkus Sample Service</title>"));
    }
    ...
    void getSamplePage() {
        given()
                ...
                .body(containsString("Hello, username1!")) // #greeting, username
                .body(containsString("<td>ValueFromTestProperties</td>")); // sampleConfig
    }
